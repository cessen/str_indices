...
//!
//! This only recognizes the line feed (LF `U+000A`) character as a line
//! break.  By happy accident, this also implies handling the
//! two-character CRLF line break correctly, due to simply ignoring the
//! carriage return (CR `U+000D`) character.
